...
[Authorize]
public class ResultadosAccesoController : BaseApiController
{
    private readonly IResultadoAccesoService _service;
    public ResultadosAccesoController(IResultadoAccesoService service) => _service = service;
