...
[Authorize]
public class TiposCambioPwdController : BaseApiController
{
    private readonly ITipoCambioPwdService _service;
    public TiposCambioPwdController(ITipoCambioPwdService service) => _service = service;
